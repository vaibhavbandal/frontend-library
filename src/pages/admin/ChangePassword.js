...
import { changePasswordAdmin, getAdminData } from "../../services/api";
...
export const ChangePassword = () => {
    ...
    const handleSubmit= async()=>{
        ...
        try {
            setLoadingBtn(true);
            const postData={email:admin.email,password:formData.password,newPassword:formData.newPassword};
            const response = await changePasswordAdmin(postData);
            setLoadingBtn(false);
