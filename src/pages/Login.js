            ...
            <div className=" border   col-12 col-sm-6 col-lg-4 p-4 ">
                ...
                <div class="row  ">
                    <div class=" col-12  ">
                        ...
                        <input onChange={handleInput} type="text" name="email" class="form-control" required />
                ...
                <div className="row">
                    ...
                    <div class=" col-12   ">
                        ...
                        <input onChange={handleInput} type="text" name="password" class="form-control" required />
